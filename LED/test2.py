...
def main():
    ...
    launchConfirm = limitswitch(False, 9, 11)  # Update with the correct GPIO pin for the limit switch
    DampConfirm = limitswitch(False, 14, 15)    # Update with the correct GPIO pin for the limit switch
