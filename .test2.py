    ...
    while True:
        ...
        try:
            while True:
                ...
                read_switch_update_leds(client_socket)  # Update the three-position switch state
                time.sleep(0.2)
                ...
                for switch in switches:
                    ...
                    if switch == 1 and switch.update() == True and linA == 'up': #Linear Actuator special command. True is down
                        switch.send(client_socket)
                        linA = 'down'
                        print(linA)
                        #if linA == "down" and switch.update() == False:
                        '''
                        if linA == 'up': #then a new event has occurred.
                            linA = 'down'
                            switch.send(client_socket)
                        elif linA == 'down':
                            pass
                        '''
                    if switch == 1 and switch.update() == True and linA == 'down': #Linear Actuator special command. True is down
                        switch.send(client_socket)
                        linA = 'up'
                        print(linA)
                        '''
                    elif switch == 1 and switch.update() == False: #Switch is up
                        if linA == 'up':
                            pass
                        elif linA == 'down':
                            linA = 'up'
                            switch.send(client_socket)
                        '''
                    #elif switch == 0 and switch.update() == False:
                    #    switch.send(client_socket)
                    else:
